...
login_check();
    ...
    $answrCD = array($_POST["answr1"], $_POST["answr2"], $answr3, $_POST["answr4"]);

    $answrCONT = array($_POST["note1"],$_POST["note2"],$cont_3,$_POST["note4"]);

    $noteArr = array("","",$note3,"");
    $pointArr = array($point1, $point2, $point3, $point4);
