...
<body id="survey">
	...
	<div class="contents">
		<form name="frm" id="frm" action="survey/survey02_2_proc.php" method="post">
			...
			<p class="Q c02"><span class="c02">환경</span><span class="txt">11. Scope1 + Scope2 배출량<span></p>
			<div class="A a01">
			...
			<input type="hidden" id="note_11_6" name="note11_6" value="<?php echo $note11Arr[5]?>">
				...
				<table class="mt10">
					...
					<tr>
                        <td><input type="text" id="q11_a4" name="answr11_4" value="<?if($answr11Arr_text[3] == ""){echo "";}else{echo $answr11Arr[3];}?>"<?if($answr11Arr_option[0] != "Y" || $answr11Arr_option[0] == null || $answr11Arr_option[1] != "Y" || $answr11Arr_option[1] == null){?>readonly<?}?>></td>
			...
			<p class="Q c02"><span class="c02">환경</span><span class="txt">12. 에너지 사용 절감량(율)<span></p>
			<div class="A a01">
				...
				<table class="mt10">
					...
					<tr>
						<td><input type="text" id="q12_a4" name="answr12_4" value="<?if($answr12Arr_text[3] == ""){echo "";}else{echo $answr12Arr[3];}?>"readonly></td>
						<td><input type="text" id="q12_a5" name="answr12_5" value="<?if($answr12Arr_text[4] == ""){echo "";}else{echo $answr12Arr[4];}?>"readonly></td>
						<td><input type="text" id="q12_a6" name="answr12_6" value="<?if($answr12Arr_text[5] == ""){echo "";}else{echo $answr12Arr[5];}?>"readonly></td>
					</tr>
					</table>
					...
					<tr>
                        <td><input type="text" id="q12_a7" name="answr12_7" value="<?if($answr12Arr_text[6] == ""){echo "";}else{echo $answr12Arr[6];}?>"readonly></td>
						<td><input type="text" id="q12_a8" name="answr12_8" value="<?if($answr12Arr_text[7] == ""){echo "";}else{echo $answr12Arr[7];}?>"readonly></td>
						<td><input type="text" id="q12_a9" name="answr12_9" value="<?if($answr12Arr_text[8] == ""){echo "";}else{echo $answr12Arr[8];}?>"readonly></td>
					</tr>
				</table>
			</div>

			<p class="Q c02"><span class="c02">환경</span><span class="txt">13. 신·재생에너지 사용량(율)<span></p>
			<div class="A a01">
			...
			<p class="Q c02"><span class="c02">환경</span><span class="txt">14. 총 원∙부자재 구매액 대비 녹색자재 구매비율<span></p>
			<div class="A a01">
			...
			<p class="Q c02"><span class="c02">환경</span><span class="txt">15. 용수 사용량<span></p>
			<div class="A a01">
			...
			<p class="Q c02"><span class="c02">환경</span><span class="txt">16. 용수 재사용량<span></p>
			<div class="A a01">
			...
			<p class="Q c02"><span class="c02">환경</span><span class="txt">17. 폐기물 배출량<span></p>
			<div class="A a01">
			...
			<p class="Q c02"><span class="c02">환경</span><span class="txt">18. 폐기물 재활용량<span></p>
			<div class="A a01">
			...
			<p class="Q c02"><span class="c02">환경</span><span class="txt">19. 대기오염물질 배출 총량<span></p>
			<div class="A a01">
			...
			<p class="Q c02"><span class="c02">환경</span><span class="txt">20. 수질오염물질 배출 총량<span></p>
			<div class="A a01">
			...
			<p class="Q c02"><span class="c02">환경</span><span class="txt">21. ISO14001 등 국제적 환경경영시스템 표준 또는 이에 준하는 인증을 획득하였습니까?<span></p>
			...
			<p class="Q c02"><span class="c02">환경</span><span class="txt">22. 사업장 활동에 요구되는 환경 인허가, 라이선스 등록이 모두 구비되어 있고 유효합니까?<br/>(오염물질 배출 시설 허가증, 폐기물 배출 신고서 등)<span></p>
			...
			<p class="Q c02"><span class="c02">환경</span><span class="txt">23. 수질오염물질 배출 환경 검사 보고서(오염물질 배출, 소음진동 자가 측정 기록부)가 구비되어 있고 인허가/라이선스 조건을 충족시킵니까?<span></p>
